                      ...
                      pxp_output_buffer_config_t* outputBufferConfig)
{
    ...
    outputBufferConfig->width  = DEMO_BUFFER_WIDTH;
    outputBufferConfig->height = DEMO_BUFFER_HEIGHT;

    PXP_SetProcessSurfaceBackGroundColor(DEMO_PXP, 0U);

    PXP_SetProcessSurfacePosition(DEMO_PXP, 0U, 0U, DEMO_BUFFER_WIDTH - 1U, DEMO_BUFFER_HEIGHT - 1U);

    PXP_SetRotateConfig(DEMO_PXP, kPXP_RotateOutputBuffer, kPXP_Rotate0, kPXP_FlipDisable);
